  ...
  return (
    <section className="py-20 md:py-28 bg-surface">
      <div className="max-w-[1400px] mx-auto px-4 md:px-8">
        ...
        >
          {entries.map((entry) => (
            <motion.div key={entry.label} variants={staggerItem}>
              <Link
                href={entry.href}
                className="group relative overflow-hidden rounded-3xl p-6 md:p-8 bg-white border border-forest-deep/5 hover:border-forest-deep/20 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl block h-full"
              >
                {/* Background accent */}
                <div
                ...
                <div className="relative">
                  <div
                    className={`inline-flex items-center justify-center w-14 h-14 rounded-2xl ${entry.color} text-white mb-5 transition-transform duration-300 group-hover:scale-110`}
                  >
