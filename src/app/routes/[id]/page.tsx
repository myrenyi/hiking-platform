...
export default function RouteDetailPage({ params }: PageProps) {
  ...
  const [routeId, setRouteId] = useState<string>("wuyuan-hike");
    ...
    <div className="bg-bg min-h-full">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-10 -mt-6 relative z-10">
        <motion.div
          ...
          className="bg-white rounded-2xl shadow-lg p-5 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4"
        >
          {[
            {
              icon: Star,
            ...
            {
              icon: MapPin,
              value: route.location.split("·")[1] || route.location,
              label: "目的地",
              color: "text-sky",
            },
            {
              icon: Sun,
              value: route.bestSeason.split("、")[0],
              label: "最佳季节",
              color: "text-orange-500",
            },
            {
              icon: Path,
              value: route.distance.split("约")[1] || route.distance,
              label: "总距离",
              color: "text-purple-600",
            },
            {
              icon: Mountains,
              value: route.elevation.split("约")[1] || route.elevation,
              label: "累计爬升",
              color: "text-rose-500",
            },
          ].map((item, i) => (
              ...
              {activeTab === 0 && (
                <div className="grid md:grid-cols-3 gap-8">
                  <div className="md:col-span-2 space-y-6">
                    <div>
                      <h2 className="text-xl font-bold text-forest-deep mb-3">
                        路线简介
                      </h2>
                  ...
                  <div className="space-y-4">
                    <div className="bg-white rounded-2xl border border-surface p-5">
                      ...
                      <div className="space-y-3 text-sm">
                        {[
                          { label: "集合地点", value: route.startLocation },
                          { label: "目的地", value: route.destination },
                          {
                            label: "难度等级",
                            value: difficultyLabels[route.difficulty],
                          },
                          { label: "行程天数", value: `${route.days}天` },
                          { label: "总距离", value: route.distance },
                          { label: "累计爬升", value: route.elevation },
                        ].map((row, i) => (
